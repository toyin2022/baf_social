  ...
  return (
    <Popover>
      <div className="flex lg:flex-row flex-col h-[100vh] lg:h-[100vh]  w-full lg:relative ">
        <div className="w-full hidden  fixed lg:w-[22%] shadow-md shadow-gray-700 bg-slate-950 text-white lg:flex  py-8 lg:flex-col gap-12 items-center lg:h-[100vh] h-[10%]">
        ...
        <div className="content h-[100%] lg:ml-[18rem] w-[100%] lg:w-[100%]  ">
